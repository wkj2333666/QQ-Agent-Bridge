...
```bash
/home/example/projects/qq-bot/.venv/bin/pytest -q tests/test_resources.py tests/test_app_async.py -k "voice or transcript"
```
...
```bash
/home/example/projects/qq-bot/.venv/bin/pytest -q tests/test_resources.py tests/test_app_async.py
/home/example/projects/qq-bot/.venv/bin/pytest -q tests/test_whisper_runner.py tests/test_onebot.py
```
...
```bash
/home/example/projects/qq-bot/.venv/bin/pytest -q
```
...
```bash
/home/example/projects/qq-bot/.venv/bin/pytest -q tests/test_resources.py -k file_id_voice_does_not_fetch_original_url_after_resolver_failure
```
