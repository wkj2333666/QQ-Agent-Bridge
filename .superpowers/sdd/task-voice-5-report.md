...
```bash
/home/example/projects/qq-bot/.venv/bin/pytest -q tests/test_deployment_docs.py
```
...
```text
/home/example/projects/qq-bot/.venv/bin/python -m pytest -q tests/test_deployment_docs.py
10 passed in 0.48s

bash -n scripts/install_whisper_cpp.sh scripts/check_whisper_cpp.sh
exit 0

/home/example/projects/qq-bot/.venv/bin/python -m pytest -q
