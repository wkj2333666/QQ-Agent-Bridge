...
```text
env UV_PROJECT_ENVIRONMENT=/home/example/projects/qq-bot/.venv uv run pytest tests/test_app_async.py::test_malformed_file_directive_sends_real_file_before_success_text -q
1 failed in 3.17s
...
```text
env UV_PROJECT_ENVIRONMENT=/home/example/projects/qq-bot/.venv uv run pytest tests/test_app_async.py -k "malformed_file_directive or missing_artifact or adapter_file_failure or delivery_failure_memory" -q
...
```text
env UV_PROJECT_ENVIRONMENT=/home/example/projects/qq-bot/.venv uv run pytest tests/test_app_async.py -k "artifact_repair or partial_adapter_failure or adapter_file_failure" -q
...
```text
env UV_PROJECT_ENVIRONMENT=/home/example/projects/qq-bot/.venv uv run pytest tests/test_app_async.py tests/test_artifact_delivery.py tests/test_outgoing_resources.py -q
141 passed in 4.06s
```
...
```text
env UV_PROJECT_ENVIRONMENT=/home/example/projects/qq-bot/.venv uv run pytest
...
```text
env UV_PROJECT_ENVIRONMENT=/home/example/projects/qq-bot/.venv uv run pytest tests/test_artifact_delivery.py tests/test_outgoing_resources.py tests/test_app_async.py tests/test_onebot.py tests/test_redact.py -q
192 passed in 3.95s
```
